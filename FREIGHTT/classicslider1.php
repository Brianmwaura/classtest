<body id="page-top" name="page-top" class="active">
    ...
    <!-- Navigation -->
        ...
        <a href="#" class="btn btn-dark btn-lg toggle">
            <span class="sr-only">Toggle Sidebar Navigation</span>
            <i class="fa fa-bars"></i>
        </a>
        <a class="btn btn-lg btn-dark" href="#top">
            <span class="sr-only">Toggle to Top Navigation</span>
            <i class="fa fa-chevron-up"></i>
        </a></pre>
                            </p>
                ...
                <div class="col-md-4 hidden-xs hidden-sm">
    				<div class="panel panel-default">
						<div class="bs-callout bs-right-panel">
							<a href="//www.ipage.com/join/index.bml?bannerID=550&AffID=743889">
								<img class="img-responsive" src="http://www.ipage.com/affiliate/banners/550" style="border:0px" alt="affiliate_link"/>
							</a>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="bs-callout bs-right-panel">
							...
							<ins class="adsbygoogle"
								style="display:block" 
								data-ad-client="ca-pub-1487659930909767" 
								data-ad-slot="6784370337" 
								data-ad-format="auto">
							</ins>
							<script>
					...
					<div class="panel panel-default">
						<div class="bs-callout bs-right-panel">
							<div class="row">
								<h3 class="text-primary">Download Resume below</h3>
							</div>
							<div class="row">
								<a type="button" class="btn btn-success btn-lg btn-block" href="https://drive.google.com/open?id=0By_9nIhC1083ZV9xQ0tDUUdsQkk" target="_blank">Click to view & download</a>
							</div>
						</div>
					</div>
				</div>
